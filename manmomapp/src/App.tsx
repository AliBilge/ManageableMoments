    ...
    <div className="App">
      ...
      <div className="ui grid container">
        ...
        <div className="ui grid container">
          ...
          <div className="two wide column">
            <div className="ui mini buttons">
              <button className="ui orange button">25 minutes</button>
              <button className="ui orange button">45 minutes</button>
              <button className="ui orange button">90 minutes</button>
            </div>
          </div>
